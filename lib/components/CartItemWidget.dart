  ...
  Widget build(BuildContext context) {
    ...
    return Dismissible(
      ...
      onDismissed: (DismissDirection direction) {
        _cartBloc.deleteEvent.add(item);
        print("deletado");
      },
      child: Container(
                ...
                child: Container(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 10),
                      StreamBuilder(
                        stream: _cartBloc.amountFlux,
                        builder:
                            (BuildContext context, AsyncSnapshot snapshot) {
                          return Text(
                            "Preço R\$ ${item.total.toStringAsFixed(2)}",
              ...
              child: Row(
                children: <Widget>[
                  IconButton(
                    ...
                    onPressed: () {
                      print("ADD");
                      _cartBloc.incrementEvent.add(item);
                    },
                  ),
                  StreamBuilder(
                    stream: _cartBloc.amountFlux,
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      _cartBloc.decrementEvent.add(item);
                      print("REMOVE");
                    },
                  ),
                ],
